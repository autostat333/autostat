...
(function(window, factory) {
  ...
  Tour = (function() {
      ...
      showStepHelper = (function(_this) {
        return function(e) {
          ...
          showPopoverAndOverlay = function() {
            //create logic to show "end_tour button" only for last step
            if ((_this._current+1)==_this._options.steps.length)
              setTimeout(function()
                {
                $('div.popover.tour-'+_this._options.name+' [data-role=end]').show();
                },0);
          ...
          if (step.autoscroll&&!disableAutoscroll) {
    ...
    Tour.prototype._isOrphan = function(step) {
      //if ((step.element == null) || !$(step.element).length || $(step.element).is(':hidden') && ($(step.element)[0].namespaceURI !== 'http://www.w3.org/2000/svg'))
      //  debugger;
